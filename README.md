...
A custom, high-performance Linux kernel (base version **4.14.190**) built specifically for the **Xiaomi Miatoll** platform (Redmi Note 9 Pro Max / Poco M2 Pro / Redmi Note 9 Pro / Redmi Note 9S) under the codename **excalibur**, targeting **Android 10** (Snapdragon 720G).

## Features 🚀

- **Kernel Base**: Upstream 4.14.190.
